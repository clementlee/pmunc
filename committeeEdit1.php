...
&& in_array($extension, $ppAllowedExts)) {
  ...
  $errors['newProfilePhoto'] = 'Invalid file type.';
	...
	$query1 = 'UPDATE COMMITTEE_INFO SET Leader="' . $newChair . '", Email="' . $newEmail . '", bio="' . $newBio . '", P_Filename="img/' . $_FILES["profilePhoto"]["name"] . '" WHERE Name="' . $committees[$index] . '";';
	...
	<body>
		...
		<div class="container" id="template-container">
			<div class="container">
				...
				<form name="editForm" role="form" action="<?php echo 'committeeEdit1.php?committee=' . $index; ?>" enctype="multipart/form-data" method="post">
                    <?php
